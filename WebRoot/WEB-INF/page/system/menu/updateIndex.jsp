				...
				<div class="addMenu">
					<ul>
						...
						<li>
							...
							<input type="radio" name="menuLeaf" id="menuLeaf1" value="1" ${(menu.menuTp==1||menuSize>0)?'disabled':''} ${menu.menuLeaf==1?'checked':'' }/>是
							<input type="radio" name="menuLeaf" id="menuLeaf0" value="0" ${(menu.menuTp==1||menuSize>0)?'disabled':''} ${menu.menuLeaf==0?'checked':'' }/>否
						</li>
						<li>
							<label>
								链接地址：
