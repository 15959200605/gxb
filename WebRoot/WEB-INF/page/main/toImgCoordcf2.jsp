...
-->
	...
	<body>
	  ...
	  <div id="imgDiv" align="center" class="img">
			...
			<input type="hidden" name="height" id="height" value="338" />
	  </div>
		<script type="text/javascript">
		  ...
		  $(document).ready(function () {
		       ...
		       function resize(){
		          ...
		          divHeight = windowH-36;
        	   	  document.getElementById("checkDiv").style.width=windowW-600;
        	   	  //初始化图片比例
		       	  initImgSize();
		       	  //初始化选择区域
		       	  myAreaSelect();
	           ...
	           ias = $('#tempImg').imgAreaSelect({ 
		           selectionColor:'white', x1: 0, y1: 0, x2: 600, y2: 338, 
          ...
          var PhotoSize = {
			  ...
			  action: function(x){
				    ...
				    if(tempWidth<=600 || tempHeight<=338){
				    	this.cpu = parseFloat(this.cpu.add(0.1),10);
				    	return;
				    }
          	 ...
          	 $.ajax({
          	 	...
          	 	success:function(data){
          	 		if(data=="-1"){
          	 		    ...
          	 		    window.parent.showPhotoMinicf2(data,"${str2}",'${str1}','${imgsrc}');
          	 		}
          	 	}
          	 });
          }
