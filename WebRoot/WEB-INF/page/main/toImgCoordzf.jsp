...
-->
	...
	<body>
	  ...
	  <div id="imgDiv" align="center" class="img">
			...
			<input type="hidden" name="width" id="width" value="250" />
		...
		<script type="text/javascript">
		  ...
		  $(document).ready(function () {
		       ...
		       function resize(){
		          ...
		          divHeight = windowH-36;
        	   	  document.getElementById("checkDiv").style.width=windowW-250;
        	   	  //初始化图片比例
		       	  initImgSize();
		       	  //初始化选择区域
		       	  myAreaSelect();
	           ...
	           ias = $('#tempImg').imgAreaSelect({ 
		           selectionColor:'white', x1: 0, y1: 0, x2: 250, y2: 250, 
          ...
          var PhotoSize = {
			  ...
			  action: function(x){
				    ...
				    if(tempWidth<=250 || tempHeight<=250){
				    	this.cpu = parseFloat(this.cpu.add(0.1),10);
				    	return;
				    }
          	 ...
          	 $.ajax({
          	 	...
          	 	success:function(data){
          	 	 if(data=="-1"){
          	 			...
          	 			window.parent.showPhotoMinizf(data,'${imgsrc}');
          	 		}
          	 	}
          	 });
          }
